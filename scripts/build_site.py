...
EXPERIENCE = [
 # Temporarily unpublished at the owner's request; uncomment to restore.
...
def layout(title, desc, content, path, scene=False, modal=False):
    ...
    nav = [('index.html#projects','Projects'),('index.html#experience','Experience'),('index.html#skills','Skills'),('index.html#about','About')]
...
<a class="skip-link" href="#main">Skip to content</a><header class="site-header"><div class="container"><a class="brand" href="{prefix}index.html" aria-label="Samarth Patel home"><span class="brand-wordmark">Samarth Patel<span aria-hidden="true">.</span></span></a><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="primary-nav" hidden>Menu</button><nav class="nav-links" id="primary-nav" aria-label="Primary">{links}<a href="{prefix}resume.html" class="button small">Résumé ↗</a><a href="{prefix}index.html#contact">Contact</a></nav></div></header>
...
def build():
    ...
    hero=f'''<section class="hero recruiter-hero"><div class="hero-copy"><span class="eyebrow">ROBOTICS SOFTWARE · AUTOMATION · EMBEDDED LINUX</span><h1 class="hero-name">Samarth Patel<span class="name-dot">.</span></h1><p class="hero-role">Robotics Software Engineer</p><p class="hero-summary">I connect sensing, planning and control with the software that makes a robot work. My focus: ROS2 navigation, robot manipulation and dependable embedded Linux.</p><p class="hero-credentials">M.Sc. Automation &amp; Robotics · TU Dortmund<br>Dortmund, Germany · Python · C++ · ROS2</p><div class="hero-actions"><a class="button primary" href="#projects">Explore my work <span aria-hidden="true">↓</span></a><a class="button" href="resume.html">View résumé</a><a class="hero-contact" href="mailto:{EMAIL}">Get in touch ↗</a></div></div><aside class="hero-evidence" aria-label="Three projects to start with"><span class="eyebrow">START WITH THE WORK</span><a href="project/turtlebot3-navigation.html"><span class="evidence-number">01</span><span><strong>Autonomous navigation</strong><small>TurtleBot3 · ROS2 · Mapping &amp; localization</small></span><span aria-hidden="true">↗</span></a><a href="project/distributed-state-estimation.html"><span class="evidence-number">02</span><span><strong>Embedded systems</strong><small>Yocto · Signed updates · Recovery</small></span><span aria-hidden="true">↗</span></a><a href="project/ur10-manipulator.html"><span class="evidence-number">03</span><span><strong>Robot manipulation</strong><small>UR10 · Kinematics · Trajectory control</small></span><span aria-hidden="true">↗</span></a></aside></section>'''
    ...
    featured='<section id="projects" class="section project-overview">'+section_heading('01','Project portfolio','13 projects across autonomy, manipulation, embedded systems and AI.')+'<div class="project-grid compact-projects">'+''.join(card(PROJECTS[s],quick=True) for s in ordered)+'</div></section>'
    ...
    ordered=FEATURED+[p['slug'] for p in DATA if p['slug'] not in FEATURED]
    body='<header class="page-header"><span class="eyebrow">PROJECT EXPLORER</span><h1>All projects.</h1><p>Browse the complete collection. Quick views keep you on this page; case studies are available when you want more detail.</p></header>'+filters+'<p id="project-count" class="result-count" role="status" aria-live="polite">13 projects</p><noscript><p>All projects are shown. Filters and quick views require JavaScript; every case study remains accessible.</p></noscript><div class="project-grid project-index compact-projects">'+''.join(card(PROJECTS[s],quick=True) for s in ordered)+'</div>'+contact()

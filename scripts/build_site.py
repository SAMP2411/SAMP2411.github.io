...
<a class="skip-link" href="#main">Skip to content</a><header class="site-header"><div class="container"><a class="brand" href="{prefix}index.html" aria-label="Samarth Patel home"><span class="brand-wordmark">Samarth Patel</span></a><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="primary-nav" hidden>Menu</button><nav class="nav-links" id="primary-nav" aria-label="Primary">{links}<a href="{prefix}resume.html" class="button small">Résumé ↗</a><a href="{prefix}index.html#contact">Contact</a></nav></div></header>
